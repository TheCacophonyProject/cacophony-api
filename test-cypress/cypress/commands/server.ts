...
export function sendMultipartMessage(url: string, jwt: string, formData: any, onComplete:any): void {
...
export function uploadFile(url : string, credName : string, fileName : string, fileType : string, data : any) {
