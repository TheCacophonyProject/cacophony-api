...
import { makeAuthorizedRequest, checkAuthorizedRequestFails,  v1ApiPath } from "../../commands/server";
...
describe("Device authorization", () => {
  ...
  const NOT_ADMIN = false;
    ...
    it("Hacker should not have any access", () => {
      logTestDescription(`Check that ${hacker} is blocked from getting device`, {});
