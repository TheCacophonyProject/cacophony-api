...
class TestEvent:
    def test_can_create_new_event(self, helper):
        ...
        assert (
            screech != no_lure_id
        ), "Events with no details should link to different eventDetailId."
    ...
    def test_devices_share_events(self, helper):
        ...
        sameDetailsDifferentDevice = actioner.record_event(
            new_event_name, {"lure_id": "possum_screech"}
        )
    ...
    def test_should_be_able_to_upload_several_events_at_same_time(self, helper):
        ...
        print(
            "And super users should be able to see get all four events for the device"
        )
