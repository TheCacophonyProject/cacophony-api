class TestEvent:
    def test_can_create_new_event(self, helper):
        ...
        sameDetailsToo = doer.record_event("EventTest_" + doer.devicename, {"lure_id": "possum_screech"})
        ...
        differentDetails = doer.record_event("EventTest_" + doer.devicename, {"lure_id": "possum_screech2"})
        ...
        differentDetails2 = doer.record_event("EventTest_" + doer.devicename, "")
