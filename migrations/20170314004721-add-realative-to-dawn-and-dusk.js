  ...
  up: function(queryInterface, Sequelize) {
    return Promise.all([
      queryInterface.addColumn(
        'AudioRecordings', 'relativeToDawn', Sequelize.INTEGER),
      queryInterface.addColumn(
        'IrVideoRecordings', 'relativeToDawn', Sequelize.INTEGER),
      queryInterface.addColumn(
        'ThermalVideoRecordings', 'relativeToDawn', Sequelize.INTEGER),
      queryInterface.addColumn(
        'AudioRecordings', 'relativeToDusk', Sequelize.INTEGER),
      queryInterface.addColumn(
        'IrVideoRecordings', 'relativeToDusk', Sequelize.INTEGER),
      queryInterface.addColumn(
        'ThermalVideoRecordings', 'relativeToDusk', Sequelize.INTEGER),
    ]);
  },
