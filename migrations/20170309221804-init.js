    ...
    return new Promise(function(resolve, reject) {
      ...
      return Promise
        ...
        .then(() => {
          ...
          return Promise.all([
            util.migrationAddBelongsTo(queryInterface,
              'AudioRecordings', 'Groups'),
            util.migrationAddBelongsTo(queryInterface,
              'IrVideoRecordings', 'Groups'),
            util.migrationAddBelongsTo(queryInterface,
              'ThermalVideoRecordings', 'Groups'),
            util.migrationAddBelongsTo(queryInterface,
              'AudioRecordings', 'Devices'),
            util.migrationAddBelongsTo(queryInterface,
              'IrVideoRecordings', 'Devices'),
            util.migrationAddBelongsTo(queryInterface,
              'ThermalVideoRecordings', 'Devices'),
            util.migrationAddBelongsTo(queryInterface, 'Devices',
              'Groups'),
            util.migrationAddBelongsTo(queryInterface, 'Devices',
              'Users'),
            util.belongsToMany(queryInterface, 'GroupUsers',
              'Groups', 'Users'),
          ]);
        })
        .then(() => {
